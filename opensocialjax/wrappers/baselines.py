...
from opensocialjax.environments.spaces import Box, Discrete, MultiDiscrete
from opensocialjax.environments.multi_agent_env import MultiAgentEnv, State
...
class CTRolloutManager(JaxMARLWrapper):
    ...
    def wrapped_reset(self, key):
        ...
        # OpenSocialJax returns array (num_agents, ...), need to convert to dict
    ...
    def wrapped_step(self, key, state, actions):
        # Convert dict actions to list/array for OpenSocialJax environments
